...
グローバルソフトウェア開発に求められるコンピテンシーの獲得をしました。",
    extraInfo: ["日付： March 2011", "対象: 通常のタスク管理アプリケーションで効率化出来なかった方", "カテゴリ: ウェブアプリケーション","使用ツール： astah, Google Group, Redmine", "開発手法： Unified Processをベースとした反復型プロセスを採用", "インフラ基盤： Google App Engine", "開発環境：Eclipse, Java, Subversion"]
  },
  {
