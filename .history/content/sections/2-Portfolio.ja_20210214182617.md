...
portfolios: [
  ...
  },
  {
    ...
    extraInfo: ["開発期間： 2010年11月～2011年2月", "対象: 一般ユーザー", "カテゴリ: モバイルアプリ、ウェブシステム", "開発手法： ウォーターフォール開発", "設計ツール： astah(UML作成支援ツール)", "インフラ基盤： Ruby on Rails", "開発環境：Eclipse, テキストエディタ", "開発言語： Java, Objective-C, Ruby, HTML, JavaScript, CSS", "提供会社： BPS株式会社"]
    },
 # {
