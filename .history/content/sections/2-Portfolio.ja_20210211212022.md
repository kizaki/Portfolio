...
portfolios: [
  ...
  },
  {
    ...
    extraInfo: ["開発期間： 2014年4月～現在", "対象: 自分の研究成果などの公開用", "カテゴリ: ウェブサイト","コミュニケーションツール： Skype, Google Group, Redmine", "開発手法： スクラッチ開発", "設計ツール： astah(UML作成支援ツール)", "インフラ基盤： App Engine(GCP)", "開発環境：Eclipse, Subversion", "開発言語： Java, HTML, JavaScript, CSS", "データベース： Cloud Bigtable(GCP)", "フレームワーク： Spring, Hibernate"]
  },
  {
